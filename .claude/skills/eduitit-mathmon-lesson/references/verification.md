...
- [ ] 마지막 단계 보상은 자동 모달보다 학생이 확인 버튼을 눌러 여는 흐름을 우선함(예: `바람 보기`, `상자 열기`)
...
## 5. 설계 철학 (AGENTS.md/CLAUDE.md 점검 질문 6개)
...
## 8. 단일 레포 GitHub Pages 배포 (eduitit-main-release 병행)
